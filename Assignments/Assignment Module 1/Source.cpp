...
LABEL:
	...
	case 6:
	{
		...
		fstream image1("apple-18.pgm");
		fstream image2("Butterfly-1.pgm");
		string i1 = " ", i2 = " ";
		int hashImagesLength[2];
		int hashImagesHeight[2];
		...
		for (int i = 0; i < 7; i++) {
			...
			if (i == 7 - 1)
			{
				hashImagesLength[0] = stoi(i1);//stoo -> string to integer func
			}
			else if (i == 7 - 2)//      ^
			{
				hashImagesHeight[0] = stoi(i1);
			}
			...
			if (i == 7 - 1)
			{
				hashImagesLength[1] = stoi(i2);//stoo -> string to integer func
			}
			else if (i == 7 - 2)//      ^
			{
				hashImagesHeight[1] = stoi(i2);
			}
		...
		HashPic1.Read("apple-18.pgm");
		HashPic2.Read("Butterfly-1.pgm");
